...
data_file = "./Data/trial_test_data.csv"
output_path1 = "./Data/test_preprocessed_trail_data.csv"
output_path2 = "./Data/test_preprocessed_trail_data_categorized.csv"
...
data_set.drop('patient_id', axis=1, inplace=True)
