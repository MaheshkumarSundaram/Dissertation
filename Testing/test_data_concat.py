...
path = "./Test_Preprocessing/Preprocessed"
all_files = glob.glob(os.path.join(path, "v500_1_epadlcs_*.csv"))
output_path = "./Data/trial_test_data.csv"
...
df_merged.to_csv(output_path, encoding='utf-8', index=False)
